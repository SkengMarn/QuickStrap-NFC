-- Direct fix for ambiguous event_id error
-- Run this SQL directly in your Supabase Dashboard SQL Editor

-- ============================================================================
-- Fix 1: Update enforce_wristband_category_limit function
-- ============================================================================
...
BEGIN
  ...
  -- FIXED: Added explicit table alias to prevent ambiguity
...
-- ============================================================================
-- Fix 2: Update can_link_wristband_to_ticket function
-- ============================================================================
...
-- Done! The functions should now work without ambiguity errors.
