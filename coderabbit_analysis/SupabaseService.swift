...
class SupabaseService: ObservableObject {
    ...
    private func refreshToken() async throws {
        ...
        do {
            ...
            print("❌ No refresh token available in Keychain: \(error)")
            await MainActor.run {
                forceLogout()
            }
            throw AuthError.noToken
            ...
            await MainActor.run {
                ...
                do {
                    ...
                    if let newRefreshToken = response.refreshToken {
                        ...
                        print("💾 Refreshed tokens stored securely in Keychain")
                    }
                } catch {
                    print("❌ Failed to store refreshed tokens in Keychain: \(error)")
    ...
    func signOut() {
        ...
        do {
            try SecureTokenStorage.clearAll()
            print("✅ Keychain tokens cleared successfully")
        } catch {
            print("❌ Failed to clear Keychain tokens: \(error)")
